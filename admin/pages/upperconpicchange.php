         ...
         <tr>
            ...
            <form action="../setting/engine.php" method="POST" enctype="multipart/form-data">
                    <td> 
	                    ...
	                    <input type="hidden" name="upperpicurl" value="<?php echo $upperconcek['upperpicurl']; ?>" >
                            
                        <label for="file-upload" class="custom-file-upload">
                             <center><i class="material-icons">cloud_upload</i><br> Şəkil seç </center></label>
                             <input id="file-upload"  name="upperpicurl" required  type="file"/>
                    </td>
                             
                    <td>   
                         <button type="submit" name="upperconsbchange" class="btn bg-deep-purple btn-circle-lg waves-effect waves-circle waves-float"><i class="material-icons">refresh</i></button>
                    </td>           
            </form>
